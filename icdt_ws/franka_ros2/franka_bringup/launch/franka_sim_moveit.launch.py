...
def robot_description_dependent_nodes_spawner(
    ...
    ros2_control_node = Node(
        ...
        parameters=[
                    ...
                    franka_controllers,
                    # moveit config/fr3_ros_controllers.yaml
...
def generate_launch_description():
    ...
    joint_state_publisher = Node(
        ...
        parameters=[
            # listen to joint_states from Gazebo
    ...
    package_path = os.path.join(get_package_share_directory('franka_description'))
    base_path = os.path.dirname(os.path.dirname(package_path)) + '/share'
